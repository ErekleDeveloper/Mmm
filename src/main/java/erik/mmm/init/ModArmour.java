...
public class ModArmour {
    ...
    public static ArmorMaterial uraniumMat = EnumHelper.addArmorMaterial("uranium", Main.MOD_ID+":uranium", 200, new int[] {4,8,7,3}, 10, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 3.0f);
